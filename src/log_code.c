...
const char* logcode_string(LogCode log_code) {
    switch (log_code) {
        ...
        case BAD_RENEW_GROUP_REQUEST: return "BAD_RENEW_GROUP_REQUEST";
        ...
        case BAD_RENEW_GROUP_RESPONSE: return "BAD_RENEW_GROUP_RESPONSE";
        ...
        case BAD_RENEW_GROUP_MSG: return "BAD_RENEW_GROUP_MSG";
